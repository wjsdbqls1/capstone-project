            ...
            <div style={modalStyles.content}>
              <div style={modalStyles.questionBox}>
                ...
                {selectedInquiry.attachment && (
                    <div style={modalStyles.attachBox}>
                ...
                {selectedInquiry.academic_event_id && academicEvents[selectedInquiry.academic_event_id] && (
                    <div style={modalStyles.eventBox}>
                        <span>📅</span>
...
const styles = {
  ...
  sortBar: { 
    ...
    backgroundColor: '#f8f9fa', padding: '10px', borderRadius: '12px', border: '1px solid #e9ecef' 
  },
  sortBtn: { padding: '8px 14px', border: '1px solid #ced4da', borderRadius: '20px', background: 'white', cursor: 'pointer', fontSize: '13px', color: '#495057', fontWeight:'500' },
  activeSortBtn: { padding: '8px 14px', border: '1px solid #003675', borderRadius: '20px', background: '#003675', color: 'white', cursor: 'pointer', fontSize: '13px', fontWeight: 'bold', boxShadow: '0 2px 4px rgba(0, 54, 117, 0.2)' },
  ...
  card: { 
    ...
    borderTop: '1px solid #e9ecef', borderRight: '1px solid #e9ecef', borderBottom: '1px solid #e9ecef',
    transition: 'transform 0.1s ease'
  },
  cardHeader: { display: 'flex', justifyContent: 'space-between', marginBottom: '8px' },
  statusBadge: { color: '#ff9800', fontWeight: 'bold', fontSize: '12px', backgroundColor:'#fff3e0', padding:'3px 8px', borderRadius:'6px' },
  eventBadge: { backgroundColor: '#ffe0b2', color: '#e65100', fontSize: '12px', padding: '3px 8px', borderRadius: '6px', fontWeight:'bold' },
  date: { color: '#adb5bd', fontSize: '12px' },
  title: { fontSize: '16px', fontWeight: 'bold', color:'#212529', marginBottom:'6px' },
  relatedEvent: { fontSize: '13px', color: '#e65100', marginTop: '4px', fontWeight:'500' },
  writerInfo: { fontSize: '13px', color: '#495057', marginTop: '8px', backgroundColor: '#f1f3f5', padding: '6px 10px', borderRadius: '6px', display: 'inline-block' }
};
...
const modalStyles = {
  ...
  modal: { width: '90%', maxWidth:'650px', maxHeight: '85%', backgroundColor: 'white', borderRadius: '16px', display: 'flex', flexDirection: 'column', overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.2)' },
  ...
  fileLink: { display:'block', color:'#003675', fontWeight:'bold', textDecoration:'underline' },
  eventBox: { marginTop:'15px', padding:'10px', backgroundColor:'#fff3e0', borderRadius:'8px', color:'#e65100', fontSize:'14px', fontWeight:'bold', display:'flex', alignItems:'center', gap:'6px' },
  answerArea: { marginBottom:'20px' },
  textarea: { width: '100%', minHeight: '150px', padding: '15px', border: '1px solid #ced4da', borderRadius: '8px', fontSize: '16px', resize: 'none', boxSizing: 'border-box', lineHeight:'1.5' },
  fileInput: { width: '100%', padding: '8px', border: '1px solid #ced4da', borderRadius: '6px', backgroundColor: '#f8f9fa' },
  submitBtn: { width: '100%', padding: '15px', backgroundColor: '#003675', color: 'white', border: 'none', borderRadius: '8px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', marginTop:'15px', boxShadow: '0 4px 6px rgba(0, 54, 117, 0.2)' }
};
