...
const calStyles = { 
    ...
    calendarWrapper: { flex: 1, borderRadius: '16px', border: '1px solid rgba(255,255,255,0.8)', backgroundColor: 'white', display: 'flex', flexDirection: 'column', overflow: 'hidden', minHeight: '400px' }, 
